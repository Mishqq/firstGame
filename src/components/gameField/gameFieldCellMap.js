...
let clickAreas = [
	{type:'numbers', x:0, y:0, w:80, h:158, c:[37]}, //zero
	...
	{type:'numbers', x:80, y:290, w: cs.w, h: cs.h, c:[0,37,1,2,3]},
	{type:'numbers', x:80, y:238, w: cs.w, h: cs.h, c:[0,1]},
	{type:'numbers', x:80, y:186, w: cs.w, h: cs.h, c:[0,1,2]},
	{type:'numbers', x:80, y:134, w: cs.w, h: cs.h, c:[0,37,2]},
	{type:'numbers', x:80, y:82, w: cs.w, h: cs.h, c:[37,2,3]},
	{type:'numbers', x:80, y:0, w: cs.w, h: cs.h+30, c:[37,3]},

	// 34,35,36
	{type:'numbers', x:1287, y:290, w:53, h: cs.h, c:[34,35,36]},
	{type:'numbers', x:1287, y:238, w:78, h: cs.h, c:[34]},
	{type:'numbers', x:1287, y:186, w:78, h: cs.h, c:[34,35]},
	{type:'numbers', x:1287, y:134, w:78, h: cs.h, c:[35]},
	{type:'numbers', x:1287, y:82, w:78, h: cs.h, c:[35,36]},
	{type:'numbers', x:1287, y:0, w: 78, h: cs.h+30, c:[36]},
];

// templates for other field cells
let rows = {
	odd: [
		{type:'numbers', x: cs.odds, y:290, w: cs.w-1, h: cs.h, c:[1,2,3]},
		{type:'numbers', x: cs.odds, y:238, w: cs.w-1, h: cs.h, c:[1]},
		{type:'numbers', x: cs.odds, y:186, w: cs.w-1, h: cs.h, c:[1,2]},
		{type:'numbers', x: cs.odds, y:134, w: cs.w-1, h: cs.h, c:[2]},
		{type:'numbers', x: cs.odds, y:82, w: cs.w-1, h: cs.h, c:[2,3]},
		{type:'numbers', x: cs.odds, y:0, w: cs.w-1, h:cs.h+30, c:[3]}
	],
	even: [
		{type:'numbers', x: cs.evs, y:290, w: cs.w, h: cs.h, c:[1,2,3,4,5,6]},
		{type:'numbers', x: cs.evs, y:238, w: cs.w, h: cs.h, c:[1,4]},
		{type:'numbers', x: cs.evs, y:186, w: cs.w, h: cs.h, c:[1,2,4,5]},
		{type:'numbers', x: cs.evs, y:134, w: cs.w, h: cs.h, c:[2,5]},
		{type:'numbers', x: cs.evs, y:82, w: cs.w, h: cs.h, c:[2,3,5,6]},
		{type:'numbers', x: cs.evs, y:0, w: cs.w, h: cs.h+30, c:[3,6]},
	]
};
